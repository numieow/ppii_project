...
NB_MOTS = 3000                              #Nombre de mots créés
...
NB_PROJETS = 50                             #Nombre de projets aléatoires créés
...
def calc_perf():
    ...
    temps_tot = []                                  #Cette liste va stocker les NB_PROJETS listes avec les temps d'execution avec 1, 2... NB_PROJETS projets
    for liste in liste_croissante:
        ...
        for i in range(len(liste_mots)):
            ...
            rec.recherche(liste_mots[i], liste)
